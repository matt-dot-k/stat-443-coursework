...
&= \frac{\sigma_Z^2}{\pi[2.3 - 2.86\cos\omega - 2.2\cos 2\omega]} \\[15pt]
\end{aligned}
$$
...
$$f(\omega) = \frac{\sigma_Z^2}{\pi[2.3 - 2.86\cos\omega - 2.2\cos 2\omega]}$$
...
throughout the entire time period. $\medskip$
